...
import { ACTIONS, statutColor, statutLabel } from "@/data/demo";
  ...
  return (
    <>
      <SectionTitle
        ...
        sub="Une vue unique de tout ce qui requiert votre attention — priorisé par le copilote"
      />
      <AiInsight
        sev={C.gold}
        kind="Anticipation"
        ...
        body={
          <>
            Traiter le <b>doublon fournisseur ACME</b> et les <b>3 pièces TVA manquantes</b> avant le 12 fév. sécurise
            la déclaration et évite une régularisation. Le copilote a déjà préparé les brouillons.
          </>
        }
